...
const Shops = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://images.unsplash.com/photo-1697347070588-2b98483c4af6?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            </section>
